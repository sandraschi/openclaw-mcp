...
| POST | /api/mcp-config/insert | Insert clawd-mcp snippet into selected client configs; body: clients (array of client ids). Backs up originals; skips if already present. |
